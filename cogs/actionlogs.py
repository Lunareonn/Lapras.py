...
class ActionLogs(commands.Cog):
    ...
    @commands.Cog.listener()  # Member ban log
    ...
    @commands.Cog.listener()  # Member unban log
    ...
    @commands.Cog.listener()  # Role creation log
    ...
    @commands.Cog.listener()  # Role delete log
